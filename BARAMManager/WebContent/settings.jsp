...
<body>
	<%
		...
		try {
			...
			fr = new FileReader("/home/hadoop/visualbaram/BARAMManager/WebContent/sampleConfig/"+ configSelect + "/conf.properties");
			//	fr = new FileReader("E:\\stsWorkspace1606\\BARAMManager\\WebContent\\sampleConfig\\"+ configSelect + "\\conf.properties");
		
	//fr = new FileReader("/usr/local/tomcat/webapps/BARAMManager/sampleConfig/"+ configSelect + "/conf.properties");
				...
				<p class='firstTabTop'>Select Config :	<%=configSelect%></p>
					<div class="jq_tabonoff comm_tab2">
								...
								<ul class='ParametersWrap'>
									<form action='timeSettings.jsp' method="post">
										<%
										...
										<input type='hidden' value='<%=configSelect%>'
											name='configSelect' />
										<li><input type='submit' value='저장' class='btn' style='float:right;margin:10px 0;'/> <br />
											</li>
									</form>
								</ul>
								<%
