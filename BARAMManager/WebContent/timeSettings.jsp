	...
	<div class='wrap'>
		...
		<div class="comm_tab1">
			...
			<div class="jq_cont tab_cont">
				...
				<div class="cont">
<p class='firstTabTop'>Time Settings & Start Select Config :
									<%=configSelect%></p>
					<div class="jq_tabonoff comm_tab2">
							...
							<div style='font:bold 13px/25px Malgun Gothic; '>	plugin setting이 완료 되었습니다.<br/><br/></div>
								...
								try {
									...
									fr = new FileReader("/home/hadoop/visualbaram/BARAMManager/WebContent/sampleConfig/"+ configSelect + "/loader.run.properties");	
										
								
									
									
									//	fr = new FileReader("E:\\stsWorkspace1606\\BARAMManager\\WebContent\\sampleConfig\\"+ configSelect + "\\loader.run.properties");
								//	fr = new FileReader("/usr/local/tomcat/webapps/BARAMManager/sampleConfig/"+ configSelect + "/loader.run.properties");
							//	
