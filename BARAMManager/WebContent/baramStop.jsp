...
<%
		...
		try {
            ...
            Process proc = rt.exec("./baramStart.sh &"); //시스템 명령어
            System.out.print("./baramStart.sh &");
		...
		<div class="jq_tabonoff comm_tab1">
			...
			<div class="jq_cont tab_cont">
				<div class="cont">
					...
					<div style='font:bold 13px/25px Malgun Gothic; margin-left:15px;' '>BARAM이 시작 되었습니다.<br/><br/></div>
						<form action='stopOk.jsp' method="post">
