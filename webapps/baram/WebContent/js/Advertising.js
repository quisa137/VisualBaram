...
var chartWidth = Math.round(window.innerWidth - 150);
var chartHeight = Math.round(window.innerHeight - 300);
...
seriesChart.width(chartWidth).height(chartHeight).margins({
	top : 50,
	right : 180,
	bottom : 75,
	left : 50
	...
	return d.time;
		...
		.ordinalColors(chartColors).legend(
				dc.legend().x(chartWidth - 170).y(chartHeight/3).itemHeight(13).gap(5));
