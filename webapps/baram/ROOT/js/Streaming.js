...
var chartWidth = Math.round(window.innerWidth * 0.9);
var chartHeight = Math.round(window.innerHeight * 0.8);
...
seriesChart.width(chartWidth).height(chartHeight).margins({
	...
	return d.time;
		...
		.legend(dc.legend().x(chartWidth - 170).y(chartHeight/5).itemHeight(13).gap(5));
