package baram.view.analysis.hurdle;
...
public class HurdleServlet extends HttpServlet {

	private static final long serialVersionUID = -201510211130L;

	Logger logger = Logger.getLogger(HurdleServlet.class.getName());
	...
	protected void service(HttpServletRequest request,
		...
		out.println(CommonHtml.getHtml("side", new String[] {
				"<div class='sideNoClickAction' id='side8'></div>",
				"<div class='sideClickAction'></div>", "img/side/s8.png",
				"img/side/s8_a.png" }));
		...
		out.println("<a class='ContentsTitle'>Composite Chart (line Chart)</a>");
//		out.println("<a class='popupBtn' id='btnClick'>Quickstart Guide</a>");
	...
	//	out.println("</form>");
		...
		out.println("{level: '1',v1: 21,v2: 0},{level: '2',v1: 5,v2: 0},");
		
		out.println("{level: '30',v1: 0,v2: 0},{level: '31',v1: 0,v2: 0},");
//	out.println(sb.toString());
		...
		out.println("	<div id='comp'></div>");
		out.println("</div>");
		out.println("<script type='text/javascript' src='js/Hurdle.js'></script>");
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
